...
export async function POST(request: NextRequest) {
  try {
    ...
    const { data, error } = await resend.emails.send({
      ...
      to: [email],
      subject: 'Welcome to AI Booking Agent - Counselor Account Created',
      html: `
      ...
      `,
      text: `Welcome to AI Booking Agent!\n\nHi ${name},\n\nYour counselor account has been successfully created. Use this link to verify your email and access your dashboard:\n\n${magicLink}\n\nThis link will expire in 15 minutes.\n\nNeed help? Contact us at support@franc-dev.space`,
    })
    ...
    console.log("Counselor signup email sent to", email)
    ...
    return NextResponse.json({ error: "Failed to create counselor account" }, { status: 500 })
  }
}
